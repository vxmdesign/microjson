...
#line 59 "JsonParser.hpp" // lalr1.cc:377
...
#line 4 "json.yy" // lalr1.cc:377
namespace JSON {
#line 136 "JsonParser.hpp" // lalr1.cc:377
  ...
  public:
    ...
    {
      // value
      char dummy1[sizeof(BaseJsonNode *)];

      // array
      char dummy2[sizeof(JsonArray*)];

      // member
      char dummy3[sizeof(JsonObjEntry*)];

      // object
      char dummy4[sizeof(JsonObject*)];
  ...
  basic_symbol (typename Base::kind_type t, const BaseJsonNode * v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const JsonArray* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const JsonObjEntry* v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_VTRUE (const location_type& l);

    static inline
    symbol_type
    make_VFALSE (const location_type& l);

    static inline
    symbol_type
    make_VNULL (const location_type& l);
    ...
    JsonParser (JsonScanner *scanner_yyarg, JsonDriver *driver_yyarg);
    virtual ~JsonParser ();
...
#line 732 "JsonParser.hpp" // lalr1.cc:377
